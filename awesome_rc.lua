...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "Term", "Browser", "Chat", "4", "5", "6", "7" }, s, awful.layout.layouts[1])
...
globalkeys = awful.util.table.join(
   ...
   -- Custom Bindings
   awful.key({ "Control", "Mod1"}, "l", function () awful.util.spawn_with_shell("slimlock") end)
)
...
local is_ex_monitor = exec("xrandr | grep \"HDMI1\" | grep \" connected\"")

if is_ex_monitor ~= '' then 
	exec("xrandr --output HDMI1 --auto")
	exec("xrandr --output HDMI1 --right-of eDP1")
end
